...
<execution_context>
@/Users/mundiprinceps/.claude/get-shit-done/workflows/execute-plan.md
@/Users/mundiprinceps/.claude/get-shit-done/templates/summary.md
[If plan contains checkpoint tasks (type="checkpoint:*"), add:]
@/Users/mundiprinceps/.claude/get-shit-done/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @/Users/mundiprinceps/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/mundiprinceps/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
## State Mutations (Edit-Source Principle)

Plans may read and write shared planning artifacts. Declare these explicitly so orchestrators know what changed:

```yaml
# Optional — add to frontmatter when plan touches shared artifacts
state_reads: [STATE.md, ROADMAP.md]         # Planning artifacts this plan reads
state_writes: [STATE.md, REQUIREMENTS.md]   # Planning artifacts this plan updates
```

**The edit-source principle:** When outputs are wrong, fix the *source* (CONTEXT.md, PLAN.md, RESEARCH.md) not the output. If a plan produces incorrect code, the fix is updating the instructions that produced it, then re-executing — not hand-editing the output. This keeps the pipeline reproducible.

**Why this matters:**
- Debugging: Know which plan changed STATE.md without reading all summaries
- Reproducibility: Re-running a plan from fixed instructions produces correct output
- Traceability: State mutations are declared, not discovered
...
See `/Users/mundiprinceps/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/mundiprinceps/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
