...
```
Task(
  prompt="Read /Users/mundiprinceps/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mundiprinceps/.claude/get-shit-done/templates/VALIDATION.md`
