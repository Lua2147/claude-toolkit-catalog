Send emails as Josh Naude from Kadenwood inboxes — single or bulk.

Josh has 154 inboxes (11 usernames × 14 domains). Daily capacity: 770 emails (5/inbox/day). All replies forward to josh@kadenwoodgroup.com.
...
**Step 1** — Create a CSV at `/tmp/josh_recipients.csv`:
```csv
...
### Check capacity:
```bash
python3 ~/Mundi\ Princeps/scripts/kw-bulk-send.py --sender josh --capacity
```
